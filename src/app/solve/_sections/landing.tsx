...
export default function LandingSection(props: { className?: string }) {
  return (
    <section className={clsx("px-4 py-20 max-sm:py-12 flex flex-col items-center justify-center", props.className)}>
